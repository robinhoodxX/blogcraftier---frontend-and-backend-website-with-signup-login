  ...
  return (
    <Box>
      ...
      <Box sx={{ width: "100%", margin: "auto" }}>
        <motion.div initial={{ y: -50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1 }} style={{ border: 'none', background: 'none' }}>
          <Box
            sx={{
              display: "flex",
      ...
      >
          ...
          >
            ...
            <Box sx={{ width: "100%" }}>
              ...
              <Typography
                variant="body2"
                align="center"
                sx={{ fontSize: { xs: 13, sm: 16, md: 16, lg: 16, xl: 16 }, color: theme => theme.palette.background.default, mb: 2 }}
              >
            ...
            <Box id="featuredsection" sx={{ mb: 4, width: "100%" }}>
              ...
              <Box>
                <Paper elevation={3} sx={{ m: 2, p: 6, borderRadius: 4 }}>
                  <Typography variant="h6" sx={{ color: theme => theme.palette.text.primary, fontWeight: "bold", fontSize: { xs: 15, sm: 20, md: 20, lg: 20, xl: 20 } }}>
                    The Future of Technology: Trends to Watch in 2024
                  </Typography>
                  <Typography variant="body2" sx={{ color: theme => theme.palette.text.secondary, mb: 1, fontSize: { xs: 10, sm: 15, md: 15, lg: 15, xl: 15 } }}>
                    by Jane Doe | Jan 15, 2024
                  </Typography>
                  <Typography variant="body1" sx={{ color: theme => theme.palette.text.secondary, fontSize: { xs: 12, sm: 15, md: 15, lg: 15, xl: 15 } }}>
                ...
                <Paper sx={{ display: { xs: "flex" }, flexDirection: { xs: "column" }, alignContent: { xs: "center" }, p: { xs: 1, sm: 3, md: 3, lg: 3, xl: 3 }, width: "95%", margin: "auto", mt: 3, backgroundColor: "transparent", boxShadow: "none" }}>
                  <Typography variant="h5" align="center" sx={{ fontSize: { xs: 20, sm: 30, md: 30, lg: 30, xl: 30 }, textAlign: { xs: "center" }, fontWeight: { xs: "bold" }, color: theme => theme.palette.text.primary, mt: { xs: 2 }, mb: 2, p: { xs: 2 } }}>
                    Recents
                  </Typography>
                  {stories.length === 0 ? (
                    ...
                    stories.map((story) => (
                      ...
                      >
                        <Typography variant="body1" sx={{ color: theme => theme.palette.text.secondary, fontSize: { xs: 12, sm: 15, md: 15, lg: 15, xl: 15 }, whiteSpace: { xs: "pre-wrap" } }}>{story.content}</Typography>
                        <Typography variant="caption" display="block" align="right" sx={{ color: theme => theme.palette.text.secondary }}>
            ...
            {/* Trending Section */}
            <Box id="trendingsection" sx={{ olor: theme => theme.palette.background.default, mb: 4, width: "100%" }}>
              <Box>
                <Typography
                  variant="body1"
                  align="left"
                  sx={{ fontSize: { xs: 20, sm: 30, md: 30, lg: 30, xl: 30 }, fontWeight: "bold", p: 2 }}
                >
                  <TrendingUpIcon
            ...
            <Box sx={{ color: theme => theme.palette.background.default, mb: 4, width: "100%" }}>
              <Box>
                <Typography
                  variant="body1"
                  sx={{ fontSize: { xs: 20, sm: 30, md: 30, lg: 30, xl: 30 }, fontWeight: "bold", p: 2 }}
                ...
                >
                  ...
                  <Box sx={{ ml: { xs: 0, sm: 4, md: 4, lg: 4, xl: 4 }, mt: { xs: 2, sm: 0, md: 0, lg: 0, xl: 0 }, mb: { xs: 4, sm: 0, md: 0, lg: 0, xl: 0 } }}>
                    ...
                    <Typography variant="body2" sx={{ color: theme => theme.palette.background.default, mb: 1, fontSize: { xs: 12, sm: 13, md: 13, lg: 13, xl: 13 } }}>
        ...
        >
          ...
          <Box sx={{ display: {xs: "flex" }, flexDirection: { xs: "column" }, alignItems: { xs: "center" }, textAlign: {sm: "center", md: "center", lg: "center", xl: "center"}, mb: 4 }}>
            <TextField
              ...
              label="Email Address"
              multiline
              sx={{ bgcolor: theme => theme.palette.background.paper, color: theme => theme.palette.text.primary, borderRadius: 1, width: {xs: "80%", sm: "300px", md: "300px", lg: "300px", xl: "300px"}, "& .MuiInputBase-root": { height: { xs: 45 }, fontSize: { xs: 12 }, padding: { xs: "0 10px" } }, "& .MuiInputLabel-root": { fontSize: { xs: 13 } 
            },
           }}
            />
            <Button
        ...
        >
          ...
          >
            <IconButton>
              <FavoriteBorderIcon sx={{ color: "white", ":hover": { color: "red" } }} />
            </IconButton>
            <IconButton>
              <ChatBubbleOutlineIcon sx={{ color: "white", ":hover": { color: "blue" } }} />
            </IconButton>
            <IconButton>
              <ShareIcon sx={{ color: "white", ":hover": { color: "green" } }} />
            </IconButton>
          </Box>
          <Box>
